<template>
  <div id="app">
   ...
   <div class='main'>
     <div class="postlist">
        <!--划重点，routerviwe标签为路由组件出口，name属性为对应路由下的组件名称，省略不写代表default-->
        <!--不同路径所显示的组件，均在这个标签呈现-->
        <router-view class="left" name="main"></router-view>
...
.postlist>.content_component.left{width: 75%;}
.postlist>.right{width: 290px;margin-left:10px;}
</style>
